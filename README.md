...
For **currently tracked work across the bounded VSM Harness OSS group**, start with the shared [`OpenSiro TODO`](https://github.com/opensiro/vsm-oss-organization/blob/main/TODO.md), then return here when the selected task is Skills-owned. The TODO selects/orders work; this repository remains authoritative for Methodology/skill task scope, evidence and acceptance.
